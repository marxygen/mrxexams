...
CURRENT_ACTION = Enum('CURRENT_ACTION', 'IDLE CHOOSING_CATEGORY QUESTION_TEXT ATTACHING_FILES TESTING')
ACTION_DATA = Enum('ACTION_DATA', 'CATEGORY_NAME QUESTION_TEXT ATTACHMENTS')
